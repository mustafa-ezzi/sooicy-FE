    ...
    {categories.map((category, index) => {
      ...
      return (
        <button
          ...
          className={`uppercase relative tracking-wide font-bold text-sm sm:text-base transition-all transform hover:scale-110 whitespace-nowrap ${
            isSelected ? 'text-[#F279AB]' : 'text-white'
          }`}
          style={{
